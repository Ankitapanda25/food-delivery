...
const stripePromise = loadStripe(
  "pk_test_51OxZH6SGsAgxdsk9e8Alop1AtJ8MvDIe7gaJwUFqdJmb02g0zs6pbpoRNJlfWvLKtVXmAoDJqB9K2Jgu8zfsvdUX00u21ytfFp"
);
...
const Cart = () => {
  ...
  const handleClick = async () => {
    ...
    let response = await fetch(
      "https://food-delivery-api-ivory.vercel.app/api/create-checkout-session",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
